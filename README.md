...
Claude Code Desktop is a powerful desktop application for working effectively with AI agents. It enables intuitive multitasking, seamless connection to any API or Service, session sharing, and a beautiful, fluid UI.

Built on the Claude Agent SDK, it provides a polished desktop experience for interacting with Claude and other AI assistants.

**Key Features:**
- Multi-session inbox with workflow management
- MCP (Model Context Protocol) integration for external tools
- Customizable permission modes (Explore, Ask, Auto)
- Theme system and beautiful UI
- Custom API Base URL support for proxy services
...
- **Custom API Base URL**: Support for proxy services and alternative endpoints
...
# Debug logging (writes to ~/Library/Logs/Claude Code Desktop/)
...
```
claudecode://allChats                    # All chats view
claudecode://allChats/chat/session123    # Specific chat
claudecode://settings                    # Settings
claudecode://sources/source/github       # Source info
claudecode://action/new-chat             # Create new chat
```
