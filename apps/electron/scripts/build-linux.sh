...
# electron-builder outputs: claude-code-desktop-x86_64.AppImage or claude-code-desktop-aarch64.AppImage
BUILT_APPIMAGE_NAME="claude-code-desktop-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: claude-code-desktop-x64.AppImage, claude-code-desktop-arm64.AppImage
APPIMAGE_NAME="claude-code-desktop-${ARCH}.AppImage"
