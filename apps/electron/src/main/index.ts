...
import { enableDebug, setPerfEnabled } from '@claude-code-desktop/shared/utils'
...
import { initBadgeIcon, initInstanceBadge, initNotificationService } from './notifications'
