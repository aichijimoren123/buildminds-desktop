 ...
 * - Location: Default (~/.claude-code-desktop/workspaces/) or Custom
 */
export function AddWorkspaceStep_CreateNew({
  ...
  const defaultBasePath = homeDir ? `${homeDir}/.claude-code-desktop/workspaces` : '~/.claude-code-desktop/workspaces'
      ...
      <div className="mt-6 w-full space-y-6">
        ...
        <div className="space-y-3">
          ...
          <AddWorkspace_RadioOption
            ...
            subtitle="under .claude-code-desktop folder"
          />
