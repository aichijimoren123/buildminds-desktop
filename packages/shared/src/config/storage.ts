...
import type { StoredAttachment, StoredMessage } from '@claude-code-desktop/core/types';
...
import type { Workspace, AuthType } from '@claude-code-desktop/core/types';
 ...
 * Returns undefined if not set (uses default Anthropic API).
 */
 ...
 * Pass undefined or empty string to clear and use default Anthropic API.
 */
