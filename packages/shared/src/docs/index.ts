...
This guide explains how to configure sources (MCP servers, APIs, local filesystems) in Claude Code.
...
This guide explains how to create and configure skills in Claude Code.
...
Claude Code uses **the identical SKILL.md format** as the Claude Code SDK. This means:

1. **Format compatibility**: Any skill written for Claude Code works in Claude Code
...
This guide explains how to customize the visual theme of Claude Code.

## Overview

Claude Code uses a 6-color theme system with cascading configuration:
