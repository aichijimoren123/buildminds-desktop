...
class ModeManager {
  ...
  setPermissionMode(sessionId: string, mode: PermissionMode): void {
    ...
    // Notify callbacks (for ClaudeCodeAgent internal sync)
...
Claude Code has three permission modes that control tool execution. The user can cycle through modes with SHIFT+TAB.
