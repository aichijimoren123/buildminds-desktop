 ...
 * - Per-source: ~/.claude-code-desktop/workspaces/{slug}/sources/{sourceSlug}/permissions.json
 *
 ...
 * Default permissions are stored at ~/.claude-code-desktop/permissions/
 */
...
/**
 * Load default permissions from ~/.claude-code-desktop/permissions/default.json
...
class PermissionsConfigCache {
  ...
  // App-level default permissions (loaded from ~/.claude-code-desktop/permissions/default.json)
   ...
   * These come from ~/.claude-code-desktop/permissions/default.json
   */
