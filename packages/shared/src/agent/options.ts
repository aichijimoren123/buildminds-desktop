...
declare const CLAUDE_CODE_CLI_VERSION: string | undefined;
...
export function getDefaultOptions(): Partial<Options> {
    ...
    if (typeof CLAUDE_CODE_CLI_VERSION !== 'undefined' && CLAUDE_CODE_CLI_VERSION != null) {
        const baseDir = join(homedir(), '.local', 'share', 'claude-code', 'versions', CLAUDE_CODE_CLI_VERSION);
        return {
