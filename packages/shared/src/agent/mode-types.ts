 ...
 *
 * The actual patterns are loaded from ~/.claude-code-desktop/permissions/default.json
 * at runtime by PermissionsConfigCache. This fallback ensures the app works
 * even if the JSON file is missing or invalid.
 *
 * To customize allowed commands, edit ~/.claude-code-desktop/permissions/default.json
 */
